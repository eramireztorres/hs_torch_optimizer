def load_model(X_train, y_train):
    """
    Returns a simple convolutional neural network (CNN) for image classification.
    ...
    Returns:
        nn.Module: A CNN for image classification.
    """
