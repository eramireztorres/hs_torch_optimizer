...
class TestModelAPIFactory:
    ...
    def test_get_provider_from_model_openrouter(self):
        ...
        assert ModelAPIFactory.get_provider_from_model('meta-llama/llama-3.1') == 'openrouter'
        assert ModelAPIFactory.get_provider_from_model('deepseek/deepseek-chat') == 'openrouter'
    ...
    def test_get_model_api_anthropic(self):
        ...
        api = ModelAPIFactory.get_model_api(provider='anthropic', model='claude-3-sonnet')
